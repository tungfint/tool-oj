...
function statusClass(text) {
  ...
  if (value.includes("⚠") || value.includes("đã tồn tại") || value.includes("Đã tồn tại") || value.includes("đã có") || value.includes("Đã có") || value.includes("Thiếu tài khoản")) return "warn";
